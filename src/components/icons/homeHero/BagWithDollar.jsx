export default function BagWithDollar({ className, props }) {
  return (
    <svg
    ...
    >
      ...
      <path
        ...
        strokeLinecap="round"
      />
      <path d="M6 12H2" stroke="#007D3B" strokeWidth="1.5" strokeLinecap="round" />
      <path d="M22 12H18" stroke="#007D3B" strokeWidth="1.5" strokeLinecap="round" />
    </svg>
  );
}
